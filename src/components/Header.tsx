/* [NOTE, hyunnnchoi, 2025.11.19] 모던한 헤더 디자인으로 개선 */
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
                <div className="flex h-16 items-center justify-between">
                    ...
                    <nav className="flex items-center gap-6">
                        ...
                        <Link 
                            href="https://github.com/hyunnnchoi" 
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-slate-200 transition-colors"
                        >
